...
#' \item AI. If AI is required 1 , If not mentioned  0
...
#' \item Korean_language. If the ability of Korean language is required -> 1 , If not mentioned -> 0
